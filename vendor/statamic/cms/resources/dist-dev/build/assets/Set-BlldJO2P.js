import { Z as defineComponent, a2 as h$1, $ as ref, au as watchEffect, av as nextTick, aw as unref, ax as getCurrentInstance, a1 as onBeforeUnmount, V as markRaw, ay as toRaw, az as reactive, aA as render, aB as shallowRef, a0 as onMounted, aC as customRef, aD as provide, _ as _export_sfc, ad as containerContextKey, aE as ManagesPreviewText, aF as HasFieldActions, I as Icon, aG as Badge, aH as Subheading, aI as Switch, aJ as FieldsProvider, aK as Fields, aL as DropdownSeparator, aM as DropdownItem, D as DropdownMenu, e as Dropdown, G as Button, r as resolveComponent, f as resolveDirective, c as createBlock, o as openBlock, k as withCtx, d as createBaseVNode, j as withModifiers, n as normalizeClass, w as withDirectives, h as createCommentVNode, a as createElementBlock, i as createVNode, N as createTextVNode, t as toDisplayString, v as vShow, H as Fragment$1, J as renderList, aN as watch, aO as reveal } from "./index-CmypY8AX.js";
  ...
  return openBlock(), createBlock(_component_node_view_wrapper, { class: "my-4" }, {
    default: withCtx(() => [
      createBaseVNode("div", {
        ...
        onCopy: _cache[2] || (_cache[2] = withModifiers(() => {
        }, ["stop"])),
        onPaste: _cache[3] || (_cache[3] = withModifiers(() => {
        }, ["stop"])),
        ...
        createBaseVNode("header", {
          class: normalizeClass(["group/header animate-border-color show-focus-within flex items-center rounded-[calc(var(--radius-lg)-1px)] px-1.5 antialiased duration-200 bg-gray-100/50 dark:bg-gray-925 hover:bg-gray-100 dark:hover:bg-gray-950/45 border-gray-300 dark:shadow-md border-b-1 border-b-transparent", {
            "bg-gray-200/50 dark:bg-gray-950/35 rounded-b-none border-b-gray-300! dark:border-b-white/10!": !$options.collapsed
          }])
        }, [
          !$options.isReadOnly ? (openBlock(), createBlock(_component_Icon, {
            key: 0,
            "data-drag-handle": "",
            name: "handles",
          ...
          createBaseVNode("button", {
            ...
            onClick: _cache[0] || (_cache[0] = (...args) => $options.toggleCollapsedState && $options.toggleCollapsedState(...args))
          }, [
            createVNode(_component_Badge, {
              ...
              default: withCtx(() => [
                $options.isSetGroupVisible ? (openBlock(), createElementBlock("span", _hoisted_3, [
                  createTextVNode(toDisplayString(_ctx.__($options.setGroup.display)) + " ", 1),
                  createVNode(_component_Icon, {
                    name: "chevron-right",
                    class: "relative top-px size-3"
                  })
                ])) : createCommentVNode("", true),
                createTextVNode(" " + toDisplayString(_ctx.__($options.config.display) || $options.config.handle), 1)
              ]),
              _: 1
            }),
            $options.config.instructions && !$options.collapsed ? withDirectives((openBlock(), createBlock(_component_Icon, {
              ...
              [_directive_tooltip, { content: _ctx.$markdown(_ctx.__($options.config.instructions)), html: true }]
            ]) : createCommentVNode("", true),
            withDirectives(createVNode(_component_Subheading, {
              innerHTML: _ctx.previewText,
              class: "overflow-hidden text-ellipsis whitespace-nowrap"
            }, null, 8, ["innerHTML"]), [
              [vShow, $options.collapsed]
            ])
          ]),
          !$options.isReadOnly ? (openBlock(), createElementBlock("div", _hoisted_4, [
            withDirectives(createVNode(_component_Switch, {
              size: "xs",
              modelValue: $options.enabled,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $options.enabled = $event)
            }, null, 8, ["modelValue"]), [
              [_directive_tooltip, $options.enabled ? _ctx.__("Included in output") : _ctx.__("Hidden from output")]
            ]),
            createVNode(_component_Dropdown, null, {
              ...
              default: withCtx(() => [
                createVNode(_component_DropdownMenu, null, {
                  default: withCtx(() => [
                    _ctx.fieldActions.length ? (openBlock(true), createElementBlock(Fragment$1, { key: 0 }, renderList(_ctx.fieldActions, (action) => {
        ...
        $options.index !== void 0 ? withDirectives((openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass({ "contain-paint": $options.collapsed })
        }, [
          createVNode(_component_FieldsProvider, {
            ...
            default: withCtx(() => [
              createVNode(_component_Fields, { class: "p-4" })
            ]),
            _: 1
          }, 8, ["fields", "field-path-prefix", "meta-path-prefix"])
        ], 2)), [
          [vShow, !$options.collapsed]
        ]) : createCommentVNode("", true)
      ], 42, _hoisted_1)
...
const SetComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "Set.vue"]]);
...
export {
  ...
  Fragment as F,
  canInsertNode as G,
  findParentNodeClosestToPos as H,
  textInputRule as I,
  SetComponent as J,
  NodeViewWrapper as K,
  getMarkRange as L,
  Mark2 as M,
  NodeSelection as N,
  getAttributes as O,
  ...
  Selection as S,
  TextSelection as T,
  NodeViewContent as U,
  VueNodeViewRenderer as V,
  index$4 as W,
  index$3 as X,
  index$2 as Y,
  index$1 as Z,
  ...
  Decoration as d,
  Transform as e,
  getTextSerializersFromSchema as f,
  getText as g,
  Node3 as h,
